...
from interaction.models import CalculatorAquila
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir_name', type=str, default="sparsify_result_aquila")
    ...
    data_path = "data/aquila"
    baseline_path = "baseline_results/aquila_baseline"
