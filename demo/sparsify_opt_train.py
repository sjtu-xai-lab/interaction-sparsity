...
from interaction.models import CalculatorOpt
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir_name', type=str, default="sparsify_result_opt")
    ...
    parser.add_argument('--mode', type=str, default="q")
    ...
    data_path = "data/opt"
    baseline_path = "baseline_results/opt_baseline"
